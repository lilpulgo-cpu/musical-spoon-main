...
from ._utils import __version__ as triton_version
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        statistics = \
           ...
           f"O^O/ \_/ \\    Torch: {torch}. CUDA: {gpu_stats.major}.{gpu_stats.minor}. CUDA Toolkit: {torch.version.cuda}. Triton: {triton_version}\n"\
